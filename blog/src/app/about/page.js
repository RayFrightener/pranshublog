    ...
    <div className={styles.page}>
      <main className={styles.main}>
        <h1 className={styles.header}>
          ...
          <a
            href="/portfolioSoftwareEngineerPranshuChawlaResume2025.docx.pdf"
        ...
        <p>
          If you’d like to explore the code behind them, visit my{" "}
          <a
            href="https://github.com/RayFrightener"
            target="_blank"
            rel="noopener noreferrer"
          >
            GitHub
        ...
        <div className={styles.projectGrid}>
          ...
          <div className={styles.projectCard}>
            ...
            <p className={styles.projectSubtitle}>
              A minimalist platform to share uplifting thoughts and connect
            ...
            <ul>
              ...
              <li>
                Scroll through a clean feed of reflections from other users.
              </li>
              <li>
                Explore users' past thoughts and personal growth over time.
              </li>
              <li>
                Track and manage your own reflections via a personal history
                log.
              </li>
            </ul>
          ...
          <div className={styles.projectCard}>
            <h3>
              <a
                ...
                title="Visit"
              >
                The Daily Task Logger
              </a>
            </h3>
            <p>
              A focused productivity tracker that helps you log goals, track
              time, and visualize daily consistency.
            </p>
            <span className={styles.projectRole}>
            ...
            <ul>
              ...
              <li>
                Instantly see your focus patterns with clean, visual charts.
              </li>
          ...
          <div className={styles.projectCard}>
            <h3>
              <a
                href="https://kindlore-qfe7.vercel.app/"
                target="_blank"
                rel="noopener noreferrer"
              >
                Kindlore
            ...
            <p>
              A personal knowledge platform to organize, reflect on, and enrich
            ...
            <ul>
              <li>
                Upload your Kindle <code>My Clippings.txt</code> file and import
                highlights.
              </li>
              <li>
                Automatic de-duplication—re-upload safely, duplicates are
                ignored.
              </li>
              <li>Add personal notes and reflections to each clipping.</li>
              <li>
                Secure Google authentication for a personalized experience.
              </li>
              <li>
                All data is encrypted end-to-end for privacy and security.
              </li>
              <li>
                Beautiful, distraction-free UI for reading and reflection.
              </li>
            </ul>
          ...
          <div className={styles.projectCard}>
            ...
            <p>
              A spiritual reading companion for the Bhagavad Gita — simple,
            ...
            <ul>
              <li>
                Read verses from Chapters 3, 4, and 12 in a focused layout.
              </li>
              <li>
                Navigate verses easily with smooth, single-page scroll UX.
              </li>
          ...
          <div className={styles.projectCard}>
            ...
            <p>
              A living digital space to explore my projects, thoughts, and
              inspirations.
            </p>
            <h4 className={styles.projectSectionTitle}>Key Features</h4>
            <ul>
              ...
              <li>
                Blog and resource links that reflect my current interests.
              </li>
